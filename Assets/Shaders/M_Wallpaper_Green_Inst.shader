Shader "Unreal/M_Wallpaper_Green_Inst"
{
    Properties
    {
		...
		Material_Texture2D_1( "B_Normal", 2D ) = "white" {}
		Material_Texture2D_2( "B_BlendMask", 2D ) = "white" {}
		Material_Texture2D_3( "BaseMask", 2D ) = "white" {}
		Material_Texture2D_4( "B_Base", 2D ) = "white" {}
		Material_Texture2D_5( "Roughness/Metalic", 2D ) = "white" {}
		Material_Texture2D_6( "B_Roughness/Metalic", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Wallpaper_Green_Inst.hlsl"

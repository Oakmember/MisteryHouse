...
MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.000000,5.000000,1.000000,6.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(-5.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.180000,0.081613,0.045000,1.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.500000,0.316790,0.133581,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.500000,0.316790,0.133581,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.180000,0.081613,0.045000,1.000000);//(Unknown)

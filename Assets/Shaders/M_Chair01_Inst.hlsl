...
MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(0.500000,0.500000,0.500000,1.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(-0.000311,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(-0.000311,0.000000,-0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local14 = ((Local6.rgb.r >= 0.50000000) ? Local11.r : Local13.r);
	MaterialFloat Local15 = ((Local6.rgb.g >= 0.50000000) ? Local11.g : Local13.g);
	MaterialFloat Local16 = ((Local6.rgb.b >= 0.50000000) ? Local11.b : Local13.b);
	MaterialFloat Local17 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local18 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,sampler_Material_Texture2D_2,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local19 = MaterialStoreTexSample(Parameters, Local18, 0);
	MaterialFloat Local20 = lerp(Material.PreshaderBuffer[5].x,Material.PreshaderBuffer[4].w,Local18.g);
